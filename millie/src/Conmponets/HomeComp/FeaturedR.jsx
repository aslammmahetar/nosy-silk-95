...
export const FeaturedR = () => {
  return (
    <div style={{height:"100vh",backgroundColor:"#d9ae98",padding:"50px 0px",textAlign:"left"}}>
       <div style={{display:"flex",width:"80%",margin:"auto",justifyContent:"center",alignItems:"center",gap:"60px"}}>
       <div style={{width:"100%"}}> 
